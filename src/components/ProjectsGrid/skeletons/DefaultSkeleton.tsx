  ...
  return (
    <>
      ...
      <div className="block md:hidden">
        <BasicImageSkeleton type="default" />
      </div>

      {/* Show animated skeleton on larger screens */}
      <motion.div
        className="hidden md:flex flex-1 w-full h-full min-h-[6rem] dark:bg-dot-white/[0.2] bg-dot-black/[0.3] relative group"
        initial={{ opacity: 0.5 }}
        whileHover={{
          opacity: 1,

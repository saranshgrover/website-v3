  ...
  return (
    <>
      ...
      <div className="block md:hidden">
        <BasicImageSkeleton type="rubiks" />
      </div>

      {/* Show Rubik's cube on larger screens */}
      <div className="hidden md:flex items-center justify-center w-full h-full bg-neutral-950">

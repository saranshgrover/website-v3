  ...
  return (
    <>
      ...
      <div className="block md:hidden">
        <BasicImageSkeleton type="dataViz" />
      </div>

      {/* Show graph visualization on larger screens */}
      <div
        className="hidden md:block relative w-full h-full min-h-[6rem] rounded-xl bg-gray-100/80 dark:bg-gray-800/50 p-4 overflow-hidden"
